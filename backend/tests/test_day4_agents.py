...
class TestReleaseNotesHandlers:
    ...
    def test_submit_handler_updates_result_dict(self) -> None:
        ...
        h["submit_release_notes"](
            {"version": "v2.0.0", "content": "# v2", "highlights": []}
        )
...
class TestEvaluationHandlers:
    ...
    def test_submit_handler_updates_result_dict(self) -> None:
        ...
        h["submit_eval_result"](
            {"overall_score": 0.7, "pass_count": 7, "fail_count": 3, "cases": []}
        )
...
class TestRagEngineerHandlers:
    ...
    def test_submit_handler_updates_result_dict(self) -> None:
        h = make_rag_engineer_handlers(_REPO)
        h["submit_rag_design"](
            {"vector_store": "Qdrant", "embedding_model": "text-embedding-3-small"}
        )
...
class TestChangelogHandlers:
    ...
    def test_submit_handler_updates_result_dict(self) -> None:
        h = make_changelog_handlers(_REPO)
        h["submit_changelog"](
            {"version": "2.0.0", "content": "## [2.0.0]", "sections": {}}
        )
...
class TestUserStoryHandlers:
    ...
    def test_submit_handler_updates_result_dict(self) -> None:
        ...
        h["submit_user_stories"](
            {"feature": "signup", "stories": [], "summary": "done"}
        )
...
class TestSecurityArchitectHandlers:
    ...
    def test_submit_handler_updates_result_dict(self) -> None:
        ...
        h["submit_threat_model"](
            {"summary": "OK", "threats": [], "overall_risk": "low"}
        )
                ...
                "tables": [
                    {
                        "name": "tasks",
                        "action": "index",
                        "rationale": "Speeds up status filter queries",
                    },
                ],
                "indexes": [
                    {
                        ...
                        "type": "btree",
                        "rationale": "Compound index for common filter",
                    },
                ],
...
class TestSpecializedAgentsDay4:
    ...
    def test_total_registry_count_includes_day4(self) -> None:
        ...
        assert (
            len(_REGISTRY) >= 27
        ), f"Expected ≥27 agents (Days 0-4), got {len(_REGISTRY)}"
